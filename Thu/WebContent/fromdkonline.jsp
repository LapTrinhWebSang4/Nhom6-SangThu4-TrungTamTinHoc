...
SELECT * from lophoc where MaKhoa="<%=id %>";
							...
							<c:forEach var="row" items="${result.rows}">
								<option value="<c:out value="${row.MaLop}"/>"><c:out
										value="${row.LichHoc}" /> room:
									<c:out value="${row.Phong}" /></option>
				...
				<div class="panel-body">
					<div class="col-md-12">
						<h3 align="center" style="color: #00ff00;">Thông tin cá nhân</h3>
					...
					<div class="form-group">
						...
						<div class="col-md-6 has-feedback">
							<label for="name" style="color: #00ff00;">Họ tên</label><input
								type="text" class="form-control input-lg" type="text"
								name="user" ng-model="user" required placeholder="Nhập họ tên">
						...
						<row>
						<div class="col-md-6">
							<label for="sdt" style="color: #00ff00;">Số điện thoại</label><input
