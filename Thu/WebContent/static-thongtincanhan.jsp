			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						...
						<li class=""><a href="static-chitietkhoahoc.jsp"> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 1
						</a> <b class="arrow"></b></li>

						<li class=""><a href=""> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 2
						</a> <b class="arrow"></b></li>

						<li class=""><a href=""> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 3
						</a> <b class="arrow"></b></li>

						<li class=""><a href=""> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 4
						</a> <b class="arrow"></b></li>

						<li class=""><a href=""> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 5
						</a> <b class="arrow"></b></li>

						<li class=""><a href=""> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 6
						</a> <b class="arrow"></b></li>

						<li class=""><a href=""> <i
								class="menu-icon fa fa-caret-right"></i> Khóa học 7
						</a> <b class="arrow"></b></li>
					</ul></li>
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class=""><a href="static-danhsachhocvien.jsp"> <i
								class="menu-icon fa fa-caret-right"></i> Danh sách học viên khóa
								1
						</a> <b class="arrow"></b></li>
				...
				<li class="active"><a href="static-thongtincanhan.jsp"> <i
							...
							<div class="">
								<div id="user-profile-1" class="user-profile row">
									<div class="col-xs-12 col-sm-3 center">
										...
										<div class="clearfix">
											<div class="grid2">
												<span class="bigger-175 blue">9/10</span> <br> Khả năng
													tiếng Anh 
											</div>

											<div class="grid2">
												<span class="bigger-175 blue">7/10</span> <br> Năng lực
										...
										<div class="profile-user-info profile-user-info-striped">
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span class="editable editable-click" id="username"><%=TenThanhVien%></span>
												</div>
											</div>
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<i class="fa fa-map-marker light-orange bigger-110"></i> <span
														class="editable editable-click" id="country"><%if(DiaChi==null){out.println("");}else{out.println(DiaChi);}%></span>
												</div>
											</div>
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span class="editable editable-click" id="signup"><%if(SoCMND==0){out.println("");}else{out.println(SoCMND);}%></span>
												</div>
											</div>
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span class="editable editable-click" id="signup"><%if(NgSinh==null){out.println("");}else{out.println(NgSinh);}%></span>
												</div>
											</div>							
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span class="editable editable-click" id="signup"><%if(Sodt==0){out.println("");}else{out.println(Sodt);}%></span>
												</div>
											</div>
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span class="editable editable-click" id="signup"><%if(Email==null){out.println("");}else{out.println(Email);}%></span>
												</div>
											</div>
										</div>
