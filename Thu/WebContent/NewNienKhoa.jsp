...
<body class="no-skin" ng-app="myApp">
							...
							<div class="boxed-group-inner">
								<div class="filter-repos filter-bar" role="search">
									<input type="text" id="your-repos-filter"
										...
										ng-model="search" tabindex="2" ng-model="khoahoc">
	...
	<form action="insertMienGiam" method="post">
		<div class="modal fade" id="myModal1" role="dialog" ng-controller="myController_nienkhoa">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="input_id">Niên khóa :</label> <select
								...
								id="modal-slt-nienkhoa"><option value="">Please select another value</option>
