	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				...
				<li class="active"><a href="static-guimail.jsp"> <i
		...
		jQuery(function($) {
					...
					.on(
							...
							function() {
								...
								setTimeout(function() {
									...
									$('#id-message-item-navbar').removeClass(
											'hide');

									//hide all footers
									$('.message-footer').addClass('hide');
									//now show the alternative footer
									$('.message-footer-style2').removeClass(
											'hide');
							...
							function() {
								...
								setTimeout(
										function() {
											...
											content.find('.scroll-track')
													.remove();
											content.find('.scroll-content')
													.children().unwrap();
			...
			var Inbox = {
				...
				display_bar : function(count) {
					if (count == 0) {
						...
						$('#id-message-list-navbar .message-toolbar').addClass(
								'hide');
						$('#id-message-list-navbar .message-infobar')
								.removeClass('hide');
					} else {
						$('#id-message-list-navbar .message-infobar').addClass(
								'hide');
						$('#id-message-list-navbar .message-toolbar')
								.removeClass('hide');
					}
				},
				select_all : function() {
				...
				select_none : function() {
					$('.message-item input[type=checkbox]').removeAttr(
							'checked').closest('.message-item').removeClass(
							'selected');
				...
				select_read : function() {
					$('.message-unread input[type=checkbox]').removeAttr(
							'checked').closest('.message-item').removeClass(
							'selected');
			...
			Inbox.show_list = function() {
				...
				$('.message-footer').addClass('hide');
				$('.message-footer:not(.message-footer-style2)').removeClass(
						'hide');
		...
		$(document).ready(function() {
			$("#btn-send").click(function() {
				...
				if($("input[type='file']").val()===""){
					$("#id-message-form").attr("enctype","application/x-www-form-urlencoded");
